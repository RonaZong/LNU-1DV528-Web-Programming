...
<!--
To next year, perhaps separate the HTML/CSS assignment and provide a pure coding exercise in JS doing Hangman.

1. Try to extend your JavaScript and make the game of Hangman.
-->
